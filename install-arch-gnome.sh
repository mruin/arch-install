#!/bin/bash
# ============================================================
# install-arch-gnome.sh v2
# Installazione Arch Linux + GNOME
# Autore: Mirko
#
...
# ============================================================
# CHROOT - CONFIGURAZIONE UTENTE
# ============================================================
section "Configurazione utente (Oh My Zsh + Greeter)"
...
warn "Al primo login terminale: paru -S ttf-nerd-fonts-symbols && p10k configure"
echo ""
